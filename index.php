    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top py-3" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="#page-top">Legion of Justice Fansite</a>
            </div>
        </nav>
        <!-- Masthead-->
            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8 col-xl-6 text-center">
                        ...
                        <hr class="divider" />
                        <p class="text-muted mb-5">Log in to learn more about the members of the Legion of Justice!</p>
                    </div>
                </div>
<!-- login form -->
  ...
  <input type="submit" value="login">
        ...
        <section class="page-section bg-dark text-white">
            <div class="container px-4 px-lg-5 text-center">
                <p class="mb-4"> the Legion of Justice are a team of original characters created in 2018 by Nicholas Beard for use in a series of novels. Originally consisting of 6 members, the team has grown and evolved over time to be a bit more diverse. </p>
            </div>
        </section>
        <!-- Footer-->
